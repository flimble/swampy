...
jQuery.extend({
	...
	merge: function( first, second ) {
		...
		///     &#10;The new array is: FindAll the results from the first array, followed
...
// FindAll jQuery objects should point back to these
...
jQuery.Event = function( src ) {
	// FindAllow instantiation without the 'new' keyword
...
if ( document.querySelectorAll ) {
	(function(){
		...
		Sizzle = function( query, context, extra, seed ) {
			...
			// Only use querySelectorFindAll on non-XML documents
...
var runtil = /Until$/,
	rparentsprev = /^(?:parents|prevUntil|prevFindAll)/,
...
jQuery.fn.extend({
	find: function( selector ) {
		...
		///     &#10;FindAll searching is done using a jQuery expression. The expression can be
...
jQuery.fn[ "replaceAll" ] = function( selector ) {
	...
	return this.pushStack( ret, "replaceFindAll", insert.selector );
};
...
jQuery.extend({
    ...
    ajax: function (url, options) {
        ...
        // FindAllow custom headers/mimetypes and early abort
...
jQuery.extend({
	...
	httpData: function( xhr, type, s ) {
		...
		// FindAllow a pre-filtering function to sanitize the response
